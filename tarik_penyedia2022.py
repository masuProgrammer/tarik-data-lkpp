...
def cek_dan_perbarui_penyedia(kode_daerah, kd_penyedia):
    ...
    file_path = os.path.join(data_api_path, daerah_folder, "epurchasing", "ECATPenyediaDetail2022.parquet")
    try:
...
for daerah in daerah_folders:
    ...
    if kd_penyedia_daerah is not None:
        ...
        file_path_parquet = os.path.join(data_api_path, daerah, "epurchasing", "ECATPenyediaDetail2022.parquet")
        file_path_excel = os.path.join(data_api_path, daerah, "epurchasing", "ECATPenyediaDetail2022.xlsx")
