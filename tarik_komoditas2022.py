...
def cek_dan_perbarui_komoditas(kode_daerah, kd_komoditas):
    ...
    file_path = os.path.join(data_api_path, daerah_folder, "epurchasing", "ECATKomoditasDetail2022.parquet")
    try:
...
def ambil_kd_komoditas(kode_daerah):
    file_path = os.path.join(data_api_path, kode_daerah, "epurchasing", "Ecat-PaketEPurchasing2022.parquet")
    try:
...
for daerah in daerah_folders:
    ...
    if kd_komoditas_daerah is not None:
        ...
        file_path_parquet = os.path.join(data_api_path, daerah, "epurchasing", "ECATKomoditasDetail2022.parquet")
        file_path_excel = os.path.join(data_api_path, daerah, "epurchasing", "ECATKomoditasDetail2022.xlsx")
